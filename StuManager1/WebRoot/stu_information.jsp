...
<div id="Function">
    <ul>
	  <li><a href="stu_3graduatecheck.faces"><img src="images/personal.png"><br />毕业信息核对</a></li>

  <li><h:commandLink action="#{userListBean.checkUser}">
	<h:graphicImage url="images/current_term_course.png"  alt="Show all projects"/>	
	<br />
	<br />
	<h:outputText value="成绩查看"/>
	</h:commandLink>
