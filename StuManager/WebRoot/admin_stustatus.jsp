...
<div id="Function">
    <ul>
	  <li><a href="admin_3importandexport.faces"><img src="images/personal.png"><br />学籍表的导入与导出</a></li>
	  <li><a href="admin_3infoquerystatistics.faces"><img src="images/achievement.png"><br />学籍信息的查询与统计</a></li>
	  <li><a href="admin_3lookandmodi.faces"><img src="images/elective.png"><br />查看与修改学籍信息</a></li>
	  <li><a href="admin_3credit.faces"><img src="images/elective_public_renew.png"><br />学分统计</a></li>
	</ul>
</div>
<div class="Line"></div>
  </body>
