...
<%	AcademicBean.getUngraduateInformation(); %>
			...
			<table width="95%"  class="TABLE_BODY" bordercolor="#777777" border="1" style="border-color:#777777;border-collapse:collapse">
				<tr class="TABLE_TH">
				  ...
				  for(int i=0;i<listnum;i++){
				   	...
				   	<td valign="middle"><%=((Student)(AcademicBean.getStudent().get(i))).getTutor() %></td>
				   	<td valign="middle"><%=((Student)(AcademicBean.getStudent().get(i))).getDegree() %></td>
