...
<div id="Function">
    <ul>
	  <li><a href="admin_3gradetime.faces"><img src="images/executeplan.png"><br />设置录入成绩起止时间</a></li>
	  <li><a href="admin_3queryandmodigrade.faces"><img src="images/dissertation.png"><br />查询与修改学生成绩</a></li>
	  <li><a href="admin_3print.faces"><img src="images/elective_result.png"><br />打印中英文成绩表</a></li>
	  <li><a href="admin_3gradeenter.faces"><img src="images/elective_public_renew.png"><br />成绩的批量录入</a></li>
	</ul>
</div>
<div class="Line"></div>
  </body>
