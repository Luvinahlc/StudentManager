...
document.writeln("<div id='Calendar' style='position:absolute; z-index:999; visibility: hidden; filter:\"progid:DXImageTransform.Microsoft.Shadow(direction=135,color=#999999,strength=3)\"'></div>");

function getDays(month, year)
{ 
 //涓嬮潰鐨勮繖娈典唬鐮佹槸鍒ゆ柇褰撳墠鏄惁鏄棸骞寸殑 
 if (1 == month) 
...
function newCalendar() { 
 ...
 for (var intWeek = 1; intWeek < tableCal.rows.length;intWeek++) 
  ...
  { 
   ...
   else if(intDay==6) //鍛ㄥ叚 
    cell.style.color='green'; 
   else if (intDay==0) //鍛ㄦ棩 
...
function ShowCalendar(InputBox)
{
 ...
 //涓嬮潰寮�杈撳嚭鏃ュ巻琛ㄦ牸(border-color:#9DBAF7)
