...
<script type="text/javascript" language="javascript" >
    function con(cno,teacher){
        if(window.confirm("确认选课？")){
           location.href="stu_3choosecourse.jsp?cno="+cno+"&teacher="+teacher;
       }
   }
</script>
<div id="Nav">
				...
				<tr class="TABLE_TH">
				  ...
				  <%int listnum=StudentBean.getCourses().size();
				   for(int i=0;i<listnum;i++){
					...
					<td><a href="javascript:con('<%=((Courseinfo)(StudentBean.getCourses().get(i))).getCno()%>','<%=((Courseplan)(StudentBean.getCrs().get(i))).getTeacher() %>')">选课</a></td>
				   	</tr>					   
				   <% }%>
			</table>
			</TABLE>
