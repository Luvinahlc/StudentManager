        ...
        <TD align="center" valign="top">
			<table width="95%"  class="TABLE_BODY" bordercolor="#777777" border="1" style="border-color:#777777;border-collapse:collapse">
				<tr class="TABLE_TH">
				  ...
				  <th >专业</th>
				  <th >方向</th>		  
				  <%int listnum=AcademicBean.getStudent().size();
				  for(int i=0;i<listnum;i++){
				   	...
				   	<% }%>
				   	<td valign="middle"><%=((Student)(AcademicBean.getStudent().get(i))).getSno() %></td>
				   	<td valign="middle"><%=((Student)(AcademicBean.getStudent().get(i))).getSname() %></td>
				   	<td valign="middle"><%=((Student)(AcademicBean.getStudent().get(i))).getGrade() %></td>
				   	<td valign="middle"><%=((Student)(AcademicBean.getStudent().get(i))).getSbirthday() %></td>
				   	<td valign="middle"><%=((Student)(AcademicBean.getStudent().get(i))).getSidno() %></td>
				   	<td valign="middle"><%=((Student)(AcademicBean.getStudent().get(i))).getSdept() %></td>
				   	<td valign="middle"><%=((Student)(AcademicBean.getStudent().get(i))).getMajor() %></td>
				   	<td valign="middle"><%=((Student)(AcademicBean.getStudent().get(i))).getField() %></td>
				  <% }%>
			</table>		
